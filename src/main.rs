...
# last_workspace = ""     # optional; toggle the previous space, like tmux switch-client -l
# last_tab = ""           # optional; toggle the previous tab of this space, like tmux last-window
...
# Live preview while navigating spaces (prefix+w) or agents (prefix+a): the
# highlighted target is focused as you move; Enter keeps it, Esc restores the
# original focus.
