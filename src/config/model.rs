...
pub struct KeysConfig {
    ...
    /// Open the agents panel navigation surface. Default: "prefix+a"
...
pub struct UiConfig {
    ...
    /// Focus the highlighted space or agent while navigating; Esc restores the original focus. Default: false.
    pub navigation_preview: bool,
